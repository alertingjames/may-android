...
import bookclub.technion.maymsgphoto.task.DecryptTask;
...
//
//        getSupportActionBar().setTitle("My Secure Castle");
//        getSupportActionBar().setSubtitle("Import your photos  >");
    ...
    public void displayUnencryptedFile(Bitmap inBitmap) {
        ...
        setContentView(R.layout.display_unencrypted_files_layout);
    ...
    private void initViewAndImages() {
        ...
        importMenu=(TextView)findViewById(R.id.importMenu);
        importMenu.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        adapter = new SecureImageAdapter(this, securedImages, "");
    ...
    public void importPics(MenuItem menuItem){
        startDisplayImportMediaActivity();
    }
    public void deleteImages(MenuItem menuItem){
        startDeleteImagesActivity();
    }
    public void moveImagesBack(MenuItem menuItem){
        startReturnImagesActivity();
    }
    public void changePwd(MenuItem menuItem){
        startDisplayCreatePwd();
    }
    ...
    private void openMenuItems() {
        View view = findViewById(R.id.importMenu);
...
//        getMenuInflater().inflate(R.menu.attach_menu, popup.getMenu());
        ...
        popupMenu.inflate(R.menu.secured_media_menu);
        Object menuHelper;
        Class[] argTypes;
        try {

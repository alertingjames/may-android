 ...
 * @author Matt
 */
public class SecureImageListAdapter extends BaseAdapter {
    ...
    public SecureImageListAdapter(Context c, Uri[] inImages, String inMode) {
        mContext = c;
    ...
    private View getImageAndTextView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.secure_image_list_item, null);

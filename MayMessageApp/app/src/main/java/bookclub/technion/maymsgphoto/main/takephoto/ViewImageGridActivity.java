...
import bookclub.technion.maymsgphoto.widgets.PictureView;
        ...
        for(int i=0; i<imageURIs.size(); i++) {
            ...
            imageViews.get(i).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Uri photoURI = FileProvider.getUriForFile(getApplication(), getApplication().getPackageName() + ".provider", new File(imageURIs.get(finalI).getPath()));

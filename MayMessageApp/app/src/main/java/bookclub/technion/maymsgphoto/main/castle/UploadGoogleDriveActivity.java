...
public class UploadGoogleDriveActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(">SHA > ", getCertificateSHA1Fingerprint(UploadGoogleDriveActivity.this));
    ...
    private void create_file_in_folder(final DriveId driveId) {
        ...
        Drive.DriveApi.newDriveContents(mGoogleApiClient).setResultCallback(new ResultCallback<DriveApi.DriveContentsResult>() {
            @Override public void onResult(@NonNull DriveApi.DriveContentsResult driveContentsResult) {
                ...
                Toast.makeText(UploadGoogleDriveActivity.this, "Uploading to drive. If you didn't fucked up something like usual you should see it there", Toast.LENGTH_LONG).show();
    ...
    public void writeToFile(String fileName, String body) {
        ...
        try {
            ...
            fos.close();
            Toast.makeText(UploadGoogleDriveActivity.this, "File created ok! Let me give you a fucking congratulations!", Toast.LENGTH_LONG).show();
        } catch (IOException e) {
